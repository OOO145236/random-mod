...
package net.mcreator.randomxd.world.inventory;
...
public class LabguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LabguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RandomXdModMenus.LABGUI.get(), id);
