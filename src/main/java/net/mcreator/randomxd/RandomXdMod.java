...
@Mod("random_xd")
public class RandomXdMod {
	public static final Logger LOGGER = LogManager.getLogger(RandomXdMod.class);
	public static final String MODID = "random_xd";
